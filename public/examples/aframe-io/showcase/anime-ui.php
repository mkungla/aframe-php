...
$aframe->scene()->entity('schematic-2')->el()->image(1)
...
$aframe->scene()->entity('schematic-2')->el()->image(2)
...
$aframe->scene()->entity('schematic-2')->el()->image(3)
...
$aframe->scene()->entity('schematic-2')->el()->image(7)
    ->mixin('image')->src('#schematic1')->scale(2, 2, 2)
    ->animation()->attribute('visible')->from('false')->to('true')->delay(1400)->dur(1)->fill('both');
$aframe->scene()->entity('schematic-2')->el()->image(8)
...
$aframe->scene()->entity('schematic-2')->el()->image(9)
...
$aframe->scene()->entity('rings-group-3')->el()->image(3)
...
$aframe->scene()->entity('rings-group-2')->el()->image(1)
...
$aframe->scene()->entity('rings-group-2')->el()->image(2)
...
$aframe->scene()->entity('rings-group-1')->el()->image(1)
...
$aframe->scene()->entity('rings-group-1')->el()->image(2)
    ->mixin('image')->src('#ring4')->scale(1.2, 1.2, 1.2)->position(0, 0, .01)
    ->animation()->attribute('visible')->from('false')->to('true')->delay(600)->dur(1)->fill('both');
$aframe->scene()->entity('rings-group-1')->el()->image(3)
    ->mixin('image')->src('#ring3')->position(0, 0, .02)
